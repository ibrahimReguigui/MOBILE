...
public class StatPieForm extends BaseForm {
 ...
 private boolean drawOnMutableImage;
    ...
    Form current;
     BaseForm form;
        public StatPieForm(Resources res)  {
        ...
        addTab(swipe, res.getImage("back-logo1.png"), spacer1, "Gerant Home");
        ...
        RadioButton mesProduits = RadioButton.createToggle("Produits", barGroup);
        mesProduits.setUIID("SelectBar");
    
        mesProduits.addActionListener((e) -> {
               InfiniteProgress ip = new InfiniteProgress();
        final Dialog ipDlg = ip.showInifiniteBlocking();

        listProduitForm a = new listProduitForm();
          a.show();
            refreshTheme();
        });
        ...
        RadioButton mesCategories = RadioButton.createToggle("Categories", barGroup);
        mesCategories.setUIID("SelectBar");

        mesCategories.addActionListener((e) -> {
               InfiniteProgress ip = new InfiniteProgress();
        final Dialog ipDlg = ip.showInifiniteBlocking();

        listCategorieForm a = new listCategorieForm();
          a.show();
            refreshTheme();
        });
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, mesProduits, mesCategories,profile),
                FlowLayout.encloseBottom(arrow)
        ));
        mesProduits.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(mesProduits, arrow);
           
        });
        bindButtonSelection(mesProduits, arrow);
        bindButtonSelection(mesCategories, arrow);
                mesProduits.addActionListener((e)->{
        });

                 mesCategories.setSelected(true);
        arrow.setVisible(false);
        addShowListener(e -> {
            arrow.setVisible(true);
            updateArrowPosition(mesCategories, arrow);
        });
        bindButtonSelection(profile, arrow);
                profile.addActionListener((e)->{
                  new StatPieForm(res).show();
