...
public class ServiceEvent {
 ...
 public void ajoutEvent(Event a) {
        ...
        String url=Statics.BASE_URL+"addEventJSON/new?nomevent="+a.getNomevent()+"&nbrplaces="+a.getNbrplaces()+"&datedebut="+a.getDatedebut()+"&datefin="+a.getDatefin()+"&location="+a.getLocation()+"&img="+a.getImg();
        ...
        String url = Statics.BASE_URL + "updateEventJSON/"+u.getIdevent()+
                "?nomevent="+u.getNomevent()+"&nbmrplaces="+u.getNbrplaces()+"&datedebut="+u.getDatedebut()+"&datefin="+u.getDatefin()+"&location="+u.getLocation()+"&img="+u.getImg();
               req.setUrl(url);
