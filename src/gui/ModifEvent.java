...
public class ModifEvent extends BaseForm {
    public ModifEvent(Resources res,Form previous,Event fi) {
        ...
        addStringValue("nombre max de places",nbrplaces);
        
        TextField datedebut = new TextField("", "entrer date debut evenement sous format yyyy-mm-dd");
        ...
        Edit.addActionListener((evt) -> {
            ...
            sp.editEvent(fi);
            Dialog.show("Success","event modifier avec success",new Command("OK"));
